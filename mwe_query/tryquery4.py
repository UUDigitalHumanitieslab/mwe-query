...
majorlemmaptslist = [ [('kunnen', 'ww'), ('bommen', 'ww')],
                    [('kunnen', 'ww'), ('velen', 'ww')],
...
mwestructs = [(kunnenbommen, 'kunnen bommen'), (mouwpassenaan, 'mouw passen aan'),
              (aantotlatenwerken, 'aantotlatenwerken'), (gordiaanseknoopdoorhakken, 'Gordiaanse knoop doorhakken')]
...
def mkcoremlq(lemmapts: List[Tuple[str, Pos]]) -> Xpathexpression:
    ...
    restconditions = [f'ancestor::alpino_ds/node[@cat="top" and descendant::[@lemma="{rlemma}" and @pt="{rpt}"]' for rlemma, rpt in rest]
