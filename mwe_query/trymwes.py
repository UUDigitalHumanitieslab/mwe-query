...
from sastadev.treebankfunctions import indextransform, showtree
...
geenhaankraaien = ('0geen *haan zal naar iets kraaien',
                   ['maar daar kraait geen haan naar maar als het er drieduizend zijn of meer staat belgie op '
                    ...
                    'er is geen haan die daar naar kraait', 'Weinig hanen die daarnaar kraaien .',
...
invoorietszijn = ('iemand zal in voor iets zijn', ['iemand zal in voor iets zijn', 'hij zal daar voor in zijn'])
voorietsinzijn = ('iemand zal voor iets in zijn', ['iemand zal voor iets in zijn', 'hij zal daar voor in zijn',
                                                   'hij zal daarvoor in zijn',
                                                   'hij zal in voor een feest zijn', 'hij zal in zijn voor een feest'])

puntjebijpaaltje = ('als puntje bij paaltje +komt', ['als puntje bij paaltje komt', 'als puntje bij paaltje kwam'])

zalwel = ('dd:[dat] +zal wel', ['het zal wel', 'dat zal wel'])

varkentjewassen = ('iemand zal 0dit +*varkentje wassen',
                   ['Een varkentje dat even vlug gewassen moest worden door PSV Eindhoven .'])

ingevalvaniets =('in geval van iets', ['in geval van ongelukken', 'in geval hiervan', 'in geval hier van'])

houdenvan = ('iemand zal van iemand|iets houden', ['hij houdt van voetbal', 'Hij houdt er niet van', 'Hij houdt ervan',
                                                   'Hij houdt daarvan', 'Hij houdt ervan om te schaken',
                                                   'hij houdt er van om te schaken',
                                                   'hij houdt er niet van om te schaken' ])
zichschamen = ('iemand zal zich schamen', ['ik schaam me', 'jij schaamt je', 'hij schaamt zich', 'zij schaamt zich',
                                           'wij schamen ons', 'jullie schamen je', 'zij schamen zich'])

zichzelfzijn = ('iemand zal zichzelf zijn', ['ik ben mijzelf', 'jij bent jezelf', 'hij is zichzelf', 'zij is zichzelf',
                                             'wij zijn onszelf', 'jullie zijn jezelf', 'zij zijn zichzelf'])

deplaatpoetsen = ('iemand zal de plaat poetsen', ['hij poetste de plaat', 'hij poetste gisteren de plaat',
                                                  'hij poetste de plaat toen hij ziek was'])

ietshebben = ('iemand|iets zal =iets hebben', ['hij heeft toch wel iets'])

tukhebben = ('iemand zal iemand tuk hebben', ['hij heeft mij tuk', 'iemand zal iemand tuk hebben'])

liegenbarsten = ('iemand zal liegen dat hij +barst', ['ik lieg dat ik barst', 'jij liegt dat je barst',
                                                      'hij liegt dat ie barst', 'wij liegen dat we barsten',
                                                      'jullie liegen dat jullie barsten', 'zij liegen dat ze barsten ',
                                                      'zij logen dat ze barstten'])
vrolijkeFrans = [('0een vrolijke Frans'), [ 'een vrolijk Fransje', 'dit vrolijke Fransje',
                                           'vrolijke Fransen', 'vrolijke Fransjes', 'een vrolijke Frans']]
