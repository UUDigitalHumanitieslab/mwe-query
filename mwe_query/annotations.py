...
basicannotationstrings = {'0', '+*', '*+', '+',
                     '*', 'dd:[', ']', '<', '>', '|', '=', '#', 'dr:[', 'id:[', 'c:'}

lvcannotationstringlist = ['DO:', 'BE:', 'BC:', 'ST:', 'CBE:', 'CBC:', 'CST:', 'GV:', 'GT:', 'LBT:']
...
annotationstrings = basicannotationstrings | lvcannotationstrings | \
                     polarityannotationstrings | meaningannotationstrings

noann, modifiable, inflectable, modandinfl, variable, bound, dd, invariable, zero, com, \
    literal, unmodifiable, unmodandinfl, dr, id, negpol, msem, lsem,\
