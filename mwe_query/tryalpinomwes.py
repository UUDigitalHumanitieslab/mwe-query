...
isentences += [(5, 'Maar we mogen de problemen waar burgers mee te maken  hebben niet onderschatten .')]
...
isentences += [(17, 'De meesten zouden zich nu vermoedelijk schamen voor wat zij mede hebben aangericht .')]
isentences += [(18, 'Het kenmerkt zich taalkundig gezien door o.m. leenwoorden uit het Frans en door sommige klanken die onder Franse invloed staan .')]
