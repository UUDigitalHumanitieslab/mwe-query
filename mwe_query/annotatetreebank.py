...
def annotatetb():
    ...
    parser = OptionParser()
    parser.add_option("-i", "--inpath", dest="inputpath",
                      help="Path to the folder containing Alpino treebank to be annotated")
    parser.add_option("-o", "--outpath", dest="outputpath",
                      help="path to the folder to put the annotated data")
    parser.add_option("-u", "--udpath", dest="udpath",
    ...
    for root, dirs, thefiles in inpathwalk:
        ...
        for infilename in xmlfiles:
            ...
            outfullname = os.path.join(fulloutpath, infilename)
        ...
        wb = mkworkbook(foldermetawbfullname, [mwemetaheader], foldermwemetarows, freeze_panes=(1,0))
    ...
    wb = mkworkbook(allmwemetafullname, [mwemetaheader], allmwemetarows, freeze_panes=(1,0))
