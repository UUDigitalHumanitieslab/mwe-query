...
class TestMweState(unittest.TestCase):
    ...
    def output_path(self, filename):
        return os.path.join(os.path.dirname(__file__), "data", "mwetreebanks", "output", filename)
    
    def expected_path(self, filename):
        return os.path.join(os.path.dirname(__file__), "data", "mwetreebanks", "expected", filename)

    def prepare_data(self):
        with ZipFile(self.data_path("mwetreebanks", "dansontspringena.zip")) as dansontspringena:
            dansontspringena.extractall(path=self.data_path("mwetreebanks", "dansontspringena"))
